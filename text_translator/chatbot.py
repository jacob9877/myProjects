...
# To activate Virtual environment, type "Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope Process", then ".venv\Scripts\activate"
...
with open('sherlock.txt', 'r', encoding='utf-8', errors='ignore') as trainingfile:
    trainingdata = trainingfile.read()
    sentences = nltk.sent_tokenize(trainingdata)# splits trainingdata string into sentences
...
for text in sentences:    
    shortSentences += re.findall(r'\A\w.+$', text[0:141])
